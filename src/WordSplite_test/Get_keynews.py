...
def get_keynews(day):
    ...
    fr1 = open(Global_param.test_root +
               'test/train_date_set1/train_date_set1_%d.txt' % day)
    fr2 = open(Global_param.test_root +
               'test/train_lastday_set/train_lastday_set1_%d.txt' % day)
    ...
    for line in fr2.readlines():
        ...
        dic_no_repeat[line.strip().split('\t')[0]] = list(
            set(dic_no_repeat[line.strip().split('\t')[0]]))
